...
import { type CtfUser, updateProfile, generateAdminToken, redeemAdminToken } from '../services/auth';
...
const CTFChallenges = () => {
    ...
    const applyCtfAcademyData = (state: CtfAcademyData) => {
